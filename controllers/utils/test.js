...
export const sendEmail = async (recipient, subject, name, email, account_number, account_name, bank, Pin) => {
...
await sendEmail("mukiala13@gmail.com", "Welcome to the Konnect family");